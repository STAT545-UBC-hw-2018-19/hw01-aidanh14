...
plot(CAN_data$year, CAN_data$lifeExp, ylim=ylims, col="blue", pch=19,main="Life Expectancy of Canadians vs. Americans", ylab="Life Expentancy (years)", xlab="Date")
par(new=TRUE)
...
There's plenty of built-in datasets in R meant just for this purpose - getting used to R. 
